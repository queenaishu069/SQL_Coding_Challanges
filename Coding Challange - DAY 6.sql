...
-- costomer name in ascending order
...
SELECT COUNT(CustomerID) AS total_no_of_customers FROM customers;

-- no of customer in each city
SELECT City, COUNT(CustomerID) AS count_of_customer
FROM customers
GROUP BY City;

-- count of customer in gender
SELECT Gender, COUNT(CustomerID) AS count_of_customer
FROM customers
GROUP BY Gender;

-- no of customer is greater then 2
SELECT City, COUNT(CustomerID) AS count_of_customer
FROM customers
GROUP BY City
HAVING  count_of_customer>2;
...
-- city wise count of customers
SELECT City,COUNT(CustomerName) count_of_customer
FROM customers
GROUP BY City
